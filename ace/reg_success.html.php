        ...
        <div id="wrapper">
            ...
            <main>
                ...
                <p>Our records show you submitted the following:<br>
                    ...
                    Emergency Contact Number: <?php echo htmlspecialchars($telephone, ENT_QUOTES, 'UTF-8'); ?><br>
                    Gender Identification: <?php echo htmlspecialchars($gid, ENT_QUOTES, 'UTF-8'); ?><br>
                    Age: <?php echo htmlspecialchars($age, ENT_QUOTES, 'UTF-8'); ?><br>
                    Event: <?php echo htmlspecialchars($event, ENT_QUOTES, 'UTF-8'); ?><br>
                    Special Accomodations: <?php echo htmlspecialchars($sacc, ENT_QUOTES, 'UTF-8'); ?><br>
                </p>
            </main>
            <footer>
